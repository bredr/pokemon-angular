...
export type Learnset = {
  __typename?: 'Learnset';
  /**
   * The back sprite for a Pokémon. For most Pokémon this will be the animated gif,
   * with some exceptions that were older-gen exclusive
   */
  ...
  num: Scalars['Int'];
  /**
   * The shiny back sprite for a Pokémon. For most Pokémon this will be the
   * animated gif, with some exceptions that were older-gen exclusive
   */
  shinyBackSprite: Scalars['String'];
  /**
   * The shiny sprite for a Pokémon. For most Pokémon this will be the animated
   * gif, with some exceptions that were older-gen exclusive
   */
  shinySprite: Scalars['String'];
  /** The species name for a Pokémon */
  species: Scalars['String'];
  /**
   * The sprite for a Pokémon. For most Pokémon this will be the animated gif, with
   * some exceptions that were older-gen exclusive
   */
  sprite: Scalars['String'];
...
export type Pokemon = {
  ...
  color: Scalars['String'];
  /**
   * Any other *cosmetic* forms for a Pokémon, distinguished from other formes as
   * cosmetic formes only change the look of the Pokémon, while other formes might
   * also change an ability, moveset or other data.
   */
...
export type Query = {
  ...
  /**
   * Gets the learnset for a given Pokémon and move.A fuzzy search is performed to
   * find a matching Pokémon and moveMultiple moves are possible by putting them in
   * an array: [move1, move2].You can also apply a generation filter (only results
   * for the given generation will be returned) with the generation argument
   */
   ...
   * You can provide "take" to limit the amount of Pokémon to return (default: 1),
   * set the offset of where to start with "offset", and reverse the entire array
   * with "reverse".
   * You can provide "takeFlavorTexts" to limit the amount of flavour texts to
   * return (default: 1), set the offset of where to start with
   * "offsetFlavorTexts", and reverse the entire array with "reverseFlavorTexts".
  ...
  getItem: Item;
  /**
   * Gets the learnsets for a given Pokémon and move.Multiple moves are possible by
   * putting them in an array: [move1, move2].You can also apply a generation
   * filter (only results for the given generation will be returned) with the
   * generation argument
   */
   ...
   * You can provide "takeFlavorTexts" to limit the amount of flavour texts to
   * return, set the offset of where to start with "offsetFlavorTexts", and reverse
   * the entire array with "reverseFlavorTexts".
   * Reversal is applied before pagination!
   */
  getPokemon: Pokemon;
  /**
...
export type SuggestionQuery = { __typename?: 'Query', getFuzzyPokemon: Array<{ __typename?: 'Pokemon', species: string }> };
...
export type PageQuery = { __typename?: 'Query', getFuzzyPokemon: Array<{ __typename?: 'Pokemon', species: string, sprite: string, height: number, baseStats: { __typename?: 'Stats', attack: number, defense: number, hp: number, speed: number, specialattack: number, specialdefense: number } }> };
...
export const SuggestionDocument = gql`
  ...
  export class SuggestionGQL extends Apollo.Query<SuggestionQuery, SuggestionQueryVariables> {
